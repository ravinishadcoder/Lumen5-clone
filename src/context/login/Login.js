      ...
      >
        ...
        <form onSubmit={loginSubmit}>         
          <FormControl fontSize="15" mt="10">
              ...
              <Input onChange={handleChange} id='email'  name='email' variant="flushed" borderColor="dark" type="email"  />
              <FormErrorMessage>error message</FormErrorMessage>
                
              <FormLabel mt="10">Password</FormLabel>
              <Input onChange={handleChange} id='password' name='password' variant="flushed" borderColor="dark" type="password" />
          </FormControl>
            
            <Button             
              type='submit' w="100%" bg="blue" colorScheme='blue' color="#fff" borderRadius="25px" mt="10" p="6"
            >Submit
            </Button>
        </form>
        ...
        <Text textAlign="left" mt="10">
          Need a Lumen5 account? <Link as={ReachLink} to='/create' color="blue">Create an account</Link>
        </Text>
        © 2022 Lumen5
      </Box>
   </Flex>
